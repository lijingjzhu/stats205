...
Classification has 4 levels (the greatest number of levels for the factors we 
are trying to impute). We see that some of the probabilities for certain levels
of the factor are really small. So given the number of missing values we have,
there are some levels of the factor that might not show up in our random 
sample. That's alright. 
