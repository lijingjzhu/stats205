...
#INCOME
=======
>>>>>>> 5e4ce766df59124f220154f5f7976831190b6d3c
police_killings %>%
  ...
  geom_boxplot(mapping = aes(x = race, y = med_income)) +
    labs(y= "Median Household Income (Dollars)", x= "Population", title="Median Income in Counties with Police Killings By Race")
...
police_killings %>%
  ...
  geom_boxplot(mapping = aes(x = race, y = poverty_pct)) +
    labs(y= "Percent Below the Poverty Line", x="Population", title="Poverty Level in Counties with Police Killings By Race")
...
police_killings %>%
  ...
  geom_boxplot(mapping = aes(x = race, y = educ_pct)) +
    labs(y= "Percent with High School Diploma/GED", x="Population", title="Educational Attainment in Counties with Police Killings By Race")
