...
boxplot(cbind(poverty_dataset$med_income, blacks_killed$med_income, whites_killed$med_income, hispanics_killed$med_income, native_american_killed$med_income))


unemployment <- read_csv("clean_data/unemployment_rate.csv", col_name = TRUE)
